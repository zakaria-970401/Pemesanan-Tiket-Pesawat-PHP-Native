...
<div id="main">
	<div class="content">
		<h3>Pesan Tiket Sekarang Juga</h3>
		<form action="insertpenumpang.php" method="POST" enctype="multipart/form-data">
			<div class="input-group">
				<input type="text" placeholder="Nomor Indentitas Konsumen" value="<?php while($rows=mysql_fetch_array($hasil)){ $num = $rows['no_identitas']+$no; echo $num; }?>" name="no_identitas" readonly> *Harap Diingat No Konsumen, Untuk Melakukan Pembayaran
			</div>
			<div class="input-group">
				<input type="text" placeholder="Nama Konsumen" name="nama_konsumen" autocomplete="off">
			</div>
			<div class="input-group">
				<input type="text" placeholder="Alamat Komsumen" style="width: 300px;" name="almt_konsumen" autocomplete="off">
			</div>
			<div class="input-group">
				<input type="text" placeholder="Nomor Telepon" name="telepon" autocomplete="off">
			</div>
			<div class="input-group">
				<input type="text" name="tmp_lahir" id="tempat" placeholder="Tempat Lahir" autocomplete="off"> /
